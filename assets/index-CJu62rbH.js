(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))l(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function l(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();const a=document.getElementById("cur"),d=document.getElementById("curR");document.addEventListener("mousemove",e=>{a.style.left=d.style.left=e.clientX+"px",a.style.top=d.style.top=e.clientY+"px"});document.querySelectorAll("a,button,.gc,.tier").forEach(e=>{e.addEventListener("mouseenter",()=>{a.style.width=a.style.height="20px",d.style.width=d.style.height="52px"}),e.addEventListener("mouseleave",()=>{a.style.width=a.style.height="10px",d.style.width=d.style.height="36px"})});window.addEventListener("scroll",()=>document.getElementById("nav").classList.toggle("sc",scrollY>60));const w=new IntersectionObserver(e=>e.forEach(t=>{t.isIntersecting&&t.target.classList.add("vis")}),{threshold:.1});document.querySelectorAll(".fu").forEach(e=>w.observe(e));const I="jaydebakayi@icloud.com";function g(e){return fetch(`https://formsubmit.co/ajax/${I}`,{method:"POST",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(e)})}function B(e){const t=document.querySelector(".form-err");t&&t.remove();const s=document.createElement("p");return s.className="form-err",s.textContent=e,s.style.cssText="font-size:.82rem;color:#9b3d2a;margin-top:.6rem;",s}let p={};function x(e,t){p={title:e,desc:t},document.getElementById("mo-body").innerHTML=L(e,t),document.getElementById("mb").classList.add("open"),document.body.style.overflow="hidden"}function f(){document.getElementById("mb").classList.remove("open"),document.body.style.overflow=""}document.getElementById("mb").addEventListener("click",e=>{e.target===document.getElementById("mb")&&f()});document.addEventListener("keydown",e=>{e.key==="Escape"&&f()});function L(e,t){return`
